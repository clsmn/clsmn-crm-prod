...
<!-- <div id="myModalEditHistory" class="modal fade" style="z-index: 20;" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Update Call History</h4>
      </div>
      <div class="modal-body">
        <form method="POST" action="#" accept-charset="UTF-8" class="form-horizontal">
           <input name="history_id" id="history_id" type="hidden" value=""> 
           <div class="form-group">
              <label for="email" class="col-md-4 control-label">Call Agenda</label> 
              <div class="col-md-6">
                <select class="form-control" name="call_agenda" id="call_agenda">
           ...
           <div class="form-group">
              <label for="password" class="col-md-4 control-label">Lead Status</label> 
              <div class="col-md-6">
           ...
           <div class="form-group">
              <label for="password" class="col-md-4 control-label">Notes</label> 
              <div class="col-md-6">
