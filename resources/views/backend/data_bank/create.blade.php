        ...
        <div class="box box-success">
            <div class="box-header with-border">
                ...
                <div class="box-tools pull-right">
                    ...
                    <a class="btn btn-success btn-xs" href="{{ route('admin.data.bank.bulk') }}">Bulk Create</a>
                    </div>
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    <div class="col-lg-10 col-lg-offset-2">
                        <div class="checkbox">
                            <label>
                                <input type="checkbox" name="assign" id="assign" value="1" {!! (old('assign')=='1')? 'checked="checked"' : '' !!}> Assign to executive
                            </label>
                        </div>
                    </div><!--col-lg-10-->
                </div><!--form control-->

                <div class="assign-fields {!! (old('assign')=='1')? '' : 'hide' !!}">
                    <div class="form-group">
...
@section('after-scripts')
    ...
    $(function() {
        ...
        $('#assign').change(function(){
            ...
            {
                $('.assign-fields').removeClass('hide');
            }else{
                $('.assign-fields').addClass('hide');
            }
        })
